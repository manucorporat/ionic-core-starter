...
App.loadStyles("ion-item_wp","\nion-item.hydrated{visibility:inherit}","ion-item-divider_wp","\nion-item-divider.hydrated{visibility:inherit}","ion-label_wp","\nion-label.hydrated{visibility:inherit}","ion-list_wp","\nion-list.hydrated{visibility:inherit}","ion-list-header_wp","\nion-list-header.hydrated{visibility:inherit}","ion-skeleton-text","\nion-skeleton-text.hydrated{visibility:inherit}");
App.loadComponents(
