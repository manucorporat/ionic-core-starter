...
App.loadStyles("ion-app_wp","\nion-app.hydrated{visibility:inherit}","ion-content_wp","\nion-content.hydrated{visibility:inherit}","ion-title_wp","\nion-title.hydrated{visibility:inherit}","ion-toolbar_wp","\nion-toolbar.hydrated{visibility:inherit}");
App.loadComponents(
