...
App.loadStyles("ion-item_ios","\nion-item.hydrated{visibility:inherit}","ion-item-divider_ios","\nion-item-divider.hydrated{visibility:inherit}","ion-label_ios","\nion-label.hydrated{visibility:inherit}","ion-list_ios","\nion-list.hydrated{visibility:inherit}","ion-list-header_ios","\nion-list-header.hydrated{visibility:inherit}","ion-skeleton-text","\nion-skeleton-text.hydrated{visibility:inherit}");
App.loadComponents(
...
[
  ...
  [ "getLabelText", /** method **/ 6, /** do not observe attribute **/ 0, /** type any **/ 1 ],
