...
App.loadStyles("ion-app_md","\nion-app.hydrated{visibility:inherit}","ion-content_md","\nion-content.hydrated{visibility:inherit}","ion-title_md","\nion-title.hydrated{visibility:inherit}","ion-toolbar_md","\nion-toolbar.hydrated{visibility:inherit}");
App.loadComponents(
