...
App.loadStyles("ion-item_md","\nion-item.hydrated{visibility:inherit}","ion-item-divider_md","\nion-item-divider.hydrated{visibility:inherit}","ion-label_md","\nion-label.hydrated{visibility:inherit}","ion-list_md","\nion-list.hydrated{visibility:inherit}","ion-list-header_md","\nion-list-header.hydrated{visibility:inherit}","ion-skeleton-text","\nion-skeleton-text.hydrated{visibility:inherit}");
App.loadComponents(
